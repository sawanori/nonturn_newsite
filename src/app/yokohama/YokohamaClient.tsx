...
export function YokohamaClient({ isHeroButtons = false }: YokohamaClientProps) {
  ...
  return (
    <>
      ...
      {/* Food Photography Service for Yokohama */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white">
              🍽️ 横浜の飲食店様向け<span className="bg-gradient-to-r from-orange-400 to-red-500 bg-clip-text text-transparent">専門撮影サービス</span>
            </h2>
            <p className="text-xl text-gray-200 mb-4">
              みなとみらい・関内・元町中華街など横浜全域で飲食店撮影に対応
            </p>
            <p className="text-lg text-gray-300 mb-8">
              料理写真・店舗内観・外観撮影 | 横浜エリア出張無料 | プロカメラマンによる撮影
            </p>
